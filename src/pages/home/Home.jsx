      ...
      <div className="container-fluid">
        ...
        <Row className="my-3">
          <Col xs={12} lg={6}> <p className="parrafo">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt esse, nam consequatur obcaecati dolorum harum deleniti vitae repellat alias ut molestiae quis soluptas et pariatur ullam id quidem possimus nostrum!
              </p></Col>
